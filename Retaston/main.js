function main() {
    ...
    var vertices = [
    // R Depan, Merah
    -1.8, -1, 3,        1, 0, 0,      // Index: 0
    -1.8, 1, 3,         1, 0, 0,      // Index: 1
    -1.4, 1, 3,         1, 0, 0,      // Index: 2
    -1.4, -1, 3,        1, 0, 0,      // Index: 3
    -1.4, 0, 3,         1, 0, 0,      // Index: 4
    -0.9, 1, 3,         1, 0, 0,      // Index: 5
    -0.9, 0, 3,         1, 0, 0,      // Index: 6
    -1.4, -0.6, 3,      1, 0, 0,      // Index: 7
    -1.2, -1, 3,        1, 0, 0,      // Index: 8
    -0.8, -1, 3,        1, 0, 0,      // Index: 9

    // R Kiri, 
    -1.8, -1, 2.5,      0, 1, 0,      // Index: 10 
    -1.8, 1, 2.5,       0, 1, 0,      // Index: 11
    -1.2, -1, 2.5,      0, 1, 0,      // Index: 12
    -1.4, -0.6, 2.5,    0, 1, 0,      // Index: 13

    // R Atas
    -0.9, 1, 2.5,       0, 1, 0,      // Index: 14

    // R kanan
    -0.9, 0, 2.5,       0, 1, 0,      // Index: 15
    -1.4, 0, 2.5,       0, 1, 0,      // Index: 16
    -0.8, -1, 2.5,      0, 1, 0,      // Index: 17
    -1.4, -0.6, 2.5,    0, 1, 0,      // Index: 18
    -1.4, -1, 2.5,      0, 1, 0,      // Index: 19

    // R belakang
    -1.8, -1, 2.5,      0, 1, 0,    // Index: 20
    -1.8, 1, 2.5,       0, 1, 0,    // Index: 21
    -1.4, 1, 2.5,       0, 1, 0,    // Index: 22
    -1.4, -1, 2.5,      0, 1, 0,    // Index: 23
    -1.4, 0, 2.5,       0, 1, 0,    // Index: 24
    -0.9, 1, 2.5,       0, 1, 0,    // Index: 25
    -0.9, 0, 2.5,       0, 1, 0,    // Index: 26
    -1.4, -0.6, 2.5,    0, 1, 0,    // Index: 27
    -1.2, -1, 2.5,      0, 1, 0,    // Index: 28
    -0.8, -1, 2.5,      0, 1, 0,    // Index: 29

    //1 Depan
    1.0, 0.5, 3,        0, 1, 0,    // Index: 30
    1.3, 1, 3,          0, 1, 0,    // Index: 31
    1.6, 1, 3,          0, 1, 0,    // Index: 32
    1.6, -1, 3,         0, 1, 0,    // Index: 33
    1.3, -1, 3,         0, 1, 0,    // Index: 34
    1.3, 0.5, 3,        0, 1, 0,    // Index: 35
    ...
    // Face A
    -0.6, 0, 0.4,      1, 1, 1,   // Index:  0    
    0, 0, 0.4,         1, 1, 1,   // Index:  1
    0,  1, 0.4,        1, 1, 1,   // Index:  2
    -0.6,  1, 0.4,     1, 1, 1,   // Index:  3
    // Face B       
    -0.6, 0,  1,        1, 1, 1,   // Index:  4
    0, 0,  1,           1, 1, 1,    // Index:  5
    0,  1,  1,          1, 1, 1,   // Index:  6
    -0.6,  1,  1,       1, 1, 1,   // Index:  7
    // Face C      
    -0.6, 0, 0.4,      1, 1, 1,   // Index:  8
    -0.6,  1, 0.4,     1, 1, 1,  // Index:  9
    -0.6,  1,  1,       1, 1, 1,   // Index: 10
    -0.6, 0,  1,        1, 1, 1,  // Index: 11
    // Face D      
    0, 0, 0.4,         1, 1, 1,    // Index: 12
    0,  1, 0.4,        1, 1, 1,    // Index: 13
    0,  1,  1,          1, 1, 1,    // Index: 14
    0, 0,  1,           1, 1, 1,    // Index: 15
    // Face E      
    -0.6, 0, 0.4,      1, 1, 1,   // Index: 16
    -0., 0,  1,         1, 1, 1,   // Index: 17
    0, 0,  1,           1, 1, 1,   // Index: 18
    0, 0, 0.4,         1, 1, 1,  // Index: 19
    // Face F     
    -0.6,  1, 0.4,     1, 1, 1,    // Index: 20
    -0.6,  1,  1,       1, 1, 1,   // Index: 21
    0,  1,  1,          1, 1, 1,    // Index: 22
    0,  1, 0.4,        1, 1, 1,    // Index: 23
];
